...
class BaseConnector(ABC):
    ...
    async def _get_session(self, source: str = "default", source_id: str = "default") -> Any:
        """从全局 SessionManager 获取或创建 session
    ...
    async def _create_persistent_context_by_cookies(
        self,
        context_id: str,
        ...
        try:
            ...
            context_result = await session_manager.agent_bay.context.get(context_id, create=True)
            ...
            session_result = await session_manager.agent_bay.create(params)
            ...
            if is_logged_in:
                ...
                delete_result = await session_manager.agent_bay.delete(session, sync_context=True)
                ...
                await session_manager.agent_bay.delete(session, sync_context=False)
